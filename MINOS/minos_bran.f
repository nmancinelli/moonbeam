...
c           rx is given in kms and is usually 2440.
...
c    spheroidal modes
c    the model has been normalised such that a density of 3345.56 mg/m**3 = 1 ;
c    pi*g=1 where g is the grav constant (6.6723e-11) and the radius of the
c    earth (rn=1737151 m) is 1. these normalizations result in 
...
c		include writing egfcns (mhr)
     ...
     +  fl1,fl2,fl3,sfl3,jcom,nord,l,kg,kount,knsw,ifanis,iback
      ...
      common/rindx/nic,noc,nsl,nicp1,nocp1,nslp1,n
      data bigg,tau/6.6723d-11,1.d3/,rhobar/3345.56d0/
